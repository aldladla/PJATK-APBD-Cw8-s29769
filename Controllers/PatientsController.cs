...

{
    ...
    public class PatientsController : ControllerBase
    {
        ...
        public async Task<IActionResult> AssignBed(string id, [FromBody] BedAssignmentPostDto dto)
        {
            ...
            if (!patientExists)
            {
                return NotFound($"Nie znaleziono pacjenta o identyfikatorze: {id}");
            }
            ...
            {
                return NotFound($"Brak wolnych łóżek typu '{dto.BedType}' na oddziale '{dto.Ward}' we wskazanym terminie.");
            }
            ...
            var responseDto = new BedAssignmentDto
            {
                Id = newAssignment.Id,
            ...
            return Created($"/api/patients/{id}/bedassignments/{newAssignment.Id}", responseDto);
        }
    }
}